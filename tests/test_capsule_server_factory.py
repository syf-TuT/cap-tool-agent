...
def test_program_generator_preserves_sampled_tokens_when_retokenization_differs() -> None:
    ...
    assert candidate.source == "print('ok')"
    assert candidate.response_token_ids == (21, 22)
    assert tokenizer.encode(candidate.source, add_special_tokens=False) == [31, 32]
